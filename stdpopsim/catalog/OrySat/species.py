...
# Recombination rate was calculated from sequences of rice F2 plants as 4.53 cM/Mb, which translates to 4.53e-8 per bp per generation.
# The effective recombination rate, adjusting for the high observed selfing rate in rice, can be calculated using the formula
#  r(1 − σ/[2 − σ]), where σ is the selfing rate, as applied in Caicedo et al.
