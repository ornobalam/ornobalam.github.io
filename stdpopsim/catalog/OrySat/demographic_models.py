...
_rufipogon = stdpopsim.Population(
    id="RUF", description="Oryza rufipogon (wild rice)"
)
_indica = stdpopsim.Population(
    id="IND",
...
def _BottMig_3C07():
    ...
    long_description = """
    The bottleneck + migration model of domesticated rice varieties (indica and tropical japonica)
    from Caicedo et al. (2007). Parameters were inferred from the site frequency spectrum (SFS), 
    ...
    # given in Table 2.
    # To rescale the parameters, Caicedo et al. assumed that rice cultivation began around 12,000 years (and therefore, generations) ago
    # T_1 × 2 x N_rufi = 12000
    
    T_1 = 12000 # time to the start of domestication
    T_B = 9000 # bottleneck lasted for 3000 years/generations

    N_rufi = 12000/(0.04 * 2) # ancestral population size = 150000, from this model
    ...
    # This actually just translates to symmetrical migration between all the populations
